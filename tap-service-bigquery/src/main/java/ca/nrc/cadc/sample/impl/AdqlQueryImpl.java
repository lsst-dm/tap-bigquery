...
public class AdqlQueryImpl extends AdqlQuery {
    ...
    protected void init() {
        ...
        tnc.put("ppdb.DiaObject", "`ppdb-dev-438721.ppdb_dm50643_1.DiaObject`");
        tnc.put("ppdb.DiaSource", "`ppdb-dev-438721.ppdb_dm50643_1.DiaSource`");
        tnc.put("ppdb.DiaForcedSource", "`ppdb-dev-438721.ppdb_dm50643_1.DiaForcedSource`");

        //tnc.put("ppdb.DiaObject", "`ppdb-prod.ppdb_lsstcam.DiaObject`");
        //tnc.put("ppdb.DiaSource", "`ppdb-prod.ppdb_lsstcam.DiaSource`");
        //tnc.put("ppdb.DiaForcedSource", "`ppdb-prod.ppdb_lsstcam.DiaForcedSource`");
